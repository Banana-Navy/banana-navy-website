...
export const articleTakeaways: Record<string, Record<Lang,string[]>> = {
  "ai-act-belgium": { fr:["Cartographier les systèmes IA et leurs usages réels.","Documenter données, responsabilités, contrôles et supervision humaine.","Traiter la conformité comme un processus continu, pas comme un document final."], nl:["Breng AI-systemen en hun echte gebruik in kaart.","Documenteer data, verantwoordelijkheden, controles en menselijk toezicht.","Behandel compliance als een continu proces, niet als een einddocument."], en:["Map AI systems and their actual use.","Document data, responsibilities, controls and human oversight.","Treat compliance as a continuous process, not a final document."] },
  "voice-agents-for-real-estate": { fr:["Qualifier sans transformer l'appel en interrogatoire.","Écrire le contexte utile dans le CRM avant le transfert.","Mesurer rendez-vous tenus et délais de réponse, pas seulement les appels traités."], nl:["Kwalificeer zonder het gesprek in een verhoor te veranderen.","Schrijf nuttige context in het CRM vóór de overdracht.","Meet afspraken en responstijd, niet alleen afgehandelde oproepen."], en:["Qualify without turning the call into an interrogation.","Write useful context to the CRM before transfer.","Measure kept appointments and response time, not just handled calls."] },
  "voice-agents-for-healthcare": { fr:["Limiter strictement l'agent aux informations et actions autorisées.","Escalader immédiatement les signaux cliniques ou urgents.","Tracer les sources, consentements et transferts sans exposer de données inutiles."], nl:["Beperk de agent strikt tot toegestane informatie en acties.","Escaleer klinische of urgente signalen onmiddellijk.","Log bronnen, toestemmingen en overdrachten zonder onnodige data bloot te geven."], en:["Strictly limit the agent to authorised information and actions.","Escalate clinical or urgent signals immediately.","Trace sources, consent and transfers without exposing unnecessary data."] },
  "how-to-appear-in-chatgpt-results": { fr:["Clarifier les entités, services, lieux et preuves sur le site.","Publier des réponses précises, sourcées et faciles à extraire.","Mesurer séparément indexabilité, visibilité Google et citations IA."], nl:["Maak entiteiten, diensten, locaties en bewijs helder op de site.","Publiceer precieze, onderbouwde en makkelijk extraheerbare antwoorden.","Meet indexeerbaarheid, Google-zichtbaarheid en AI-citaties afzonderlijk."], en:["Clarify entities, services, locations and evidence on the site.","Publish precise, sourced and extractable answers.","Measure indexability, Google visibility and AI citations separately."] },
  "why-most-ai-pocs-fail": { fr:["Définir une métrique métier avant de choisir le modèle.","Tester les cas limites et les reprises humaines dès le prototype.","Prévoir propriétaire, budget de maintenance et procédure d'arrêt."], nl:["Definieer een businessmetric vóór u een model kiest.","Test edge cases en menselijke overname al in het prototype.","Voorzie eigenaar, onderhoudsbudget en stopprocedure."], en:["Define a business metric before choosing a model.","Test edge cases and human takeover during the prototype.","Assign ownership, maintenance budget and a shutdown procedure."] },
  "n8n-vs-make-vs-zapier": { fr:["Choisir selon la sensibilité des données et le niveau de contrôle.","Évaluer la complexité d'exploitation, pas seulement la vitesse du prototype.","Prévoir export, logs, reprise d'erreur et coût à volume réel."], nl:["Kies op basis van datagevoeligheid en gewenste controle.","Evalueer operationele complexiteit, niet alleen prototypesnelheid.","Voorzie export, logs, foutafhandeling en kosten op echt volume."], en:["Choose based on data sensitivity and required control.","Evaluate operational complexity, not just prototype speed.","Plan for export, logs, error recovery and cost at real volume."] },
  "what-is-an-agentic-system": { fr:["Un agent combine objectif, état, outils, règles et mémoire contrôlée.","L'orchestration décide qui agit, avec quelles permissions et dans quel ordre.","Les limites, évaluations et journaux font partie du produit, pas de l'après-projet."], nl:["Een agent combineert doel, state, tools, regels en gecontroleerd geheugen.","Orkestratie bepaalt wie handelt, met welke rechten en in welke volgorde.","Grenzen, evaluaties en logs zijn deel van het product, niet van de nazorg."], en:["An agent combines a goal, state, tools, rules and controlled memory.","Orchestration decides who acts, with which permissions and in what order.","Limits, evaluations and logs are part of the product, not an afterthought."] },
};

export const locations = ["charleroi", "brussels", "liege", "namur", "mons"] as const;
export const locationNames: Record<(typeof locations)[number], string> = { charleroi: "Charleroi", brussels: "Bruxelles / Brussel", liege: "Liège", namur: "Namur", mons: "Mons" };
export const locationContexts: Record<(typeof locations)[number],Localized> = {
  charleroi:{ fr:"Notre base opérationnelle est à Gosselies, au cœur de l'écosystème A6K. Cette proximité facilite les ateliers, les pilotes et le suivi des entreprises du Hainaut.", nl:"Onze operationele basis ligt in Gosselies, binnen het A6K-ecosysteem. Die nabijheid ondersteunt workshops, pilots en opvolging voor bedrijven in Henegouwen.", en:"Our operating base is in Gosselies, within the A6K ecosystem. That proximity supports workshops, pilots and ongoing delivery for organisations in Hainaut." },
  brussels:{ fr:"À Bruxelles, les parcours doivent souvent fonctionner en français, néerlandais et anglais, avec des intégrations à des équipes et systèmes distribués.", nl:"In Brussel moeten customer journeys vaak in het Frans, Nederlands en Engels werken, met integraties naar verspreide teams en systemen.", en:"In Brussels, customer journeys often need to work in French, Dutch and English while integrating distributed teams and systems." },
  liege:{ fr:"Pour les entreprises liégeoises, nous privilégions des pilotes rapidement mesurables dans le support, la qualification et les opérations internes.", nl:"Voor organisaties in Luik geven we voorrang aan snel meetbare pilots in support, kwalificatie en interne operations.", en:"For organisations in Liège, we prioritise quickly measurable pilots in support, qualification and internal operations." },
  namur:{ fr:"À Namur, les exigences de traçabilité, d'accessibilité et de gouvernance sont centrales pour les acteurs publics, associatifs et les PME de services.", nl:"In Namen staan traceerbaarheid, toegankelijkheid en governance centraal voor publieke organisaties, verenigingen en dienstverlenende kmo's.", en:"In Namur, traceability, accessibility and governance are central for public bodies, associations and service SMEs." },
  mons:{ fr:"Depuis Charleroi, nous accompagnons les équipes de Mons et du Hainaut avec des ateliers de proximité et une intégration aux outils déjà en place.", nl:"Vanuit Charleroi ondersteunen we teams in Bergen en Henegouwen met lokale workshops en integratie in bestaande tools.", en:"From Charleroi, we support teams in Mons and Hainaut with nearby workshops and integration into existing tools." },
};

export const allPublicRoutes = () => {
  const routes: string[][] = [["expertise"], ["approach"], ["lab"], ["locations"], ["team"], ["faq"], ["legal"], ["privacy"]];
...
export const isIndexableRoute = (slug: string[]) => !(slug[0] === "lab" && slug.length > 1);
